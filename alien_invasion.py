import sys
from time import sleep #allows us to pause the game
import pygame
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.bg_color = (230,230,230) #colors (RGB) range from 0-255
    ...
    def _check_events(self): #one underscore indicates a helper method
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT:
            ...
            self.ship.moving_right = True #x-position of ship will move to the right forever
    ...
    def _check_keyup_events(self, event):
        """Respond to releases"""
        if event.key == pygame.K_RIGHT:
            self.ship.moving_right = False #Stops it from moving
        elif event.key == pygame.K_LEFT:
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left >0:
            ...
            #Create a new fleet of aliens and center schip
            self._create_fleet()
            self.ship.center_ship()
...
if __name__ == '__main__': #making sure it runs from our program and not something else
